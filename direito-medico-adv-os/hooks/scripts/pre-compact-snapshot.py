...
<COWORK>/direito-medico/.snapshots/pre-compact-<timestamp>.md.
...
def _collect_memories(cowork: Path) -> list[tuple[str, Path]]:
    ...
    # Areas: primeiro nivel de subpastas (exclui direito-medico e dot-dirs)
...
def main() -> int:
    ...
    snapshots_dir = cowork / "direito-medico" / ".snapshots"
