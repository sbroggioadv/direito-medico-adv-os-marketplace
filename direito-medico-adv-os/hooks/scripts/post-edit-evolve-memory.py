...
<COWORK>/direito-medico/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "direito-medico" / "cowork-state.json"
    ...
    pending_path = cowork / "direito-medico" / ".memory-evolver-pending.json"
